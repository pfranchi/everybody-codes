...
class EC2025Quest17Test extends AbstractQuestTest {
    ...
    void part1Examples() {
        ...
        List<String> expectedResults = List.of("1573");
    ...
    void part2Examples() {
        ...
        List<String> expectedResults = List.of("1090");
        assertEquals(expectedResults, actualResults);
    }
    ...
    void part3Examples() {
        ...
        List<String> expectedResults = List.of("592", "330", "3180");
        assertEquals(expectedResults, actualResults);
    }
