...
class EC2024Quest06Test extends AbstractQuestTest {
    ...
    @Order(2)
    void part1() {
        executeQuest(solution, 1, "RRHCZGCVCNRV@");
    }
    ...
    @Order(4)
    void part2() {
        executeQuest(solution, 2, "RZBZFSCKCX@");
    }
    ...
    @Order(6)
    void part3() {
        executeQuest(solution, 3, "RZHKTSNDCLLP@");
    }
