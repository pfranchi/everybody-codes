...
class EC2024Quest16Test extends AbstractQuestTest {

    private static final EC2024Quest16 solution = new EC2024Quest16();
    ...
    void part2Examples() {
        ...
        List<String> expectedResults = Collections.singletonList("280014668134");
        assertEquals(expectedResults, actualResults);
    }
    ...
    @Order(4)
    void part2() {
        executeQuest(solution, 2, "132299794058");
    }
