...
class EC2024Quest05Test extends AbstractQuestTest {
    ...
    @Order(4)
    void part2() {
        executeQuest(solution, 2, "17005087678734");
    }
    ...
    @Order(6)
    void part3() {
        executeQuest(solution, 3, "5491100510091000");
    }
